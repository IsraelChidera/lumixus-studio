...
const FloatingButton = () => {
    ...
    return (
        <button
            className={`fixed bottom-[140px] md:right-4 right-4 p-4 md:p-6 z-30 drop-shadow-2xl rounded-full bg-primary animate-bounce text-white ${showButton ? 'block' : 'hidden'}`}
            onClick={scrollToTop}
        >
            <IoIosArrowUp />
        </button>
